...
This project is a practical implementation of what I’ve learned in mobile app development using flutter, with a strong focus on user security and modern app architecture.
